...
namespace NexApply.Api.Migrations
{
    ...
    [Migration("20260423132331_SimplifyResumeArchitecture")]
    partial class SimplifyResumeArchitecture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexApply.Api.Entities.Education", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NexApply.Api.Entities.ResumeContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NexApply.Api.Entities.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NexApply.Api.Entities.WorkExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NexApply.Api.Entities.ResumeContent", b =>
                {
                    b.HasOne("NexApply.Api.Entities.StudentProfile", "StudentProfile")
                        .WithOne("ResumeContent")
                        .HasForeignKey("NexApply.Api.Entities.ResumeContent", "StudentProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
